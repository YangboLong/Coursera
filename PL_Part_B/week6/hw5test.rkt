...
(define tests
  (test-suite
   ...
   (check-equal? (racketlist->mupllist (list 3 (var "4"))) (apair 3 (apair (var "4") (aunit))))
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "y" (int 5))) (var "x"))) (int 10))
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "y" (int 5))) (var "y"))) (int 5))
